...
public class DrawRecordPanel {
	...
	private JComboBox<String> findBy;
	...
	public JComboBox<String> getWindows() {
		return windows;
	}
	...
	public JComboBox<String> getFindBy() {
		return findBy;
	}
